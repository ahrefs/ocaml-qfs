...
(* OASIS_START *)
(* DO NOT EDIT (digest: d84bf76ba2a0ec174d981823013b2209) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors = ["ygrek"];
          homepage = Some "http://qfs.forge.ocamlcore.org/";
          synopsis = "qfs bindings";
          description = Some "API to access QFS";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlidl"];
                      bs_c_sources = ["qfs_stubs.c"; "cxx_wrapped.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             [
                                ...
                                "-Wno-write-strings";
                                "-I";
                                "/home/ygrek/work/contrib/qfs/build/release/include"
                             ])
                        ];
                      bs_cclib =
                        [
                           (OASISExpr.EBool true,
                             [
                                ...
                                "-lqfs_common";
                                "-lpthread";
                                "-L/home/ygrek/work/contrib/qfs/build/release/lib"
                             ])
                        ];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "qfs"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlidl"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for qfs";
                      doc_authors = ["ygrek"];
                      doc_abstract = None;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "g*\175\209\002w<\177\166[KZ\154\000n\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
