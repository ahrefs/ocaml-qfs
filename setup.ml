...
(* OASIS_START *)
(* DO NOT EDIT (digest: 06f738afca76e588bbe42f5f3fa07da2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "API to access QFS"];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "6\196\029\194\246\145\165\229\160gza\159\235*\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
